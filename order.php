...
<head>
  ...
  <form  id="pizza-form" name="mForm" method="post" action="vieworder.php" novalidate>
    ...
    <h3>Total Price is: €<span id="pricetext" value="">18</span></h3>
    <input type="hidden" name="hiddenPrice" id="mPrice" value=""/>
